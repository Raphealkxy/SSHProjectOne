...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/customer_search.action"
		method=post>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><a href="${pageContext.request.contextPath }/customer_deleteCus.action?cid=${customer.cid}">删除</a>
